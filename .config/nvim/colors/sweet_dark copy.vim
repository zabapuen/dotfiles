...
" Description: Modified version of dark-purple.vim to match the Sweet KDE theme
" Webpage:     https://github.com/jschmold/sweet-dark.vim
"
" Original Author:      Harish Chandran (mail.harish.chandran@gmail.com)
" Original Webpage:     https://github.com/shapeoflambda/dark-purple.vim
" Original Description: Port of the intellij's dark purple theme
" Changes:              All guibg from dark-purple.vim match Candy now
...
let g:colors_name = "sweet_dark"

highlight Normal         guifg=#c8c8d0 guibg=#060d14 guisp=#060d14 gui=NONE      ctermfg=252  ctermbg=235  cterm=NONE
...
highlight ErrorMsg       guifg=#ff1f66 guibg=#060d14 guisp=#060d14 gui=NONE      ctermfg=167  ctermbg=235  cterm=NONE
highlight Float          guifg=#A1A6A8 guibg=NONE    guisp=NONE    gui=NONE      ctermfg=248  ctermbg=NONE cterm=NONE
highlight FoldColumn     guifg=#c8c8d0 guibg=#060d14 guisp=#060d14 gui=NONE      ctermfg=252  ctermbg=235  cterm=NONE
...
highlight NonText        guifg=#060d14 guibg=#060d14 guisp=#060d14 gui=NONE      ctermfg=235  ctermbg=235  cterm=NONE
...
highlight SpellBad       guifg=#ff1f66 guibg=#060d14 guisp=#060d14 gui=undercurl ctermfg=167  ctermbg=235  cterm=undercurl
...
highlight Todo           guifg=#c3a45b guibg=#060d14 guisp=#060d14 gui=NONE      ctermfg=179  ctermbg=235  cterm=NONE
...
highlight  *        guifg=#c8c8d0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
